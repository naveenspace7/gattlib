...
class Adapter:
    ...
    def scan_enable(self, on_discovered_device_callback, timeout):
        ...
        return gattlib.gattlib_adapter_scan_enable(self._adapter, gattlib_discovered_device_type(self.on_discovered_device), timeout)
    
    def scan_disable(self):
        return gattlib.gattlib_adapter_scan_disable(self._adapter)
